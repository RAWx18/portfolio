              ...
              return (
                ...
                >
                  {isIconItem ? (
                    ...
                    <Image src={item.img} alt={item.label} width={16} height={16} className="w-4 h-4 md:w-3.5 md:h-3.5 object-contain grayscale dark:invert opacity-70 hover:opacity-100 transition-opacity" />
                  ) : (
