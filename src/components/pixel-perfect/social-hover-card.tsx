...
const darkBannerImage = "/linkedin_cover.jpeg";
...
const socialProfiles: Record<string, SocialProfile> = {
  GitHub: {
    name: "Ryan Madhuwala",
    handle: "RAWx18",
    avatar: "https://github.com/RAWx18.png",
    bio: "Google Me 😉",
    location: "Ahmedabad, India (UTC +05:30)",
    stats: [
      { value: "9000+", label: "Contributions" },
      { value: "65", label: "Followers" },
    ],
  },
  Twitter: {
    name: "Ryan Madhuwala",
    handle: "@RAWx18_dev",
    avatar: "https://unavatar.io/twitter/RAWx18_dev",
    banner: darkBannerImage,
    bio: "About Me? Just GPT me 😏",
    location: "Ahmedabad, India (UTC +05:30)",
    stats: [
      { value: "94", label: "Following" },
      { value: "72", label: "Followers" },
    ],
  },
  LinkedIn: {
    name: "Ryan Madhuwala",
    handle: "in/ryanmadhuwala",
    avatar: "https://github.com/RAWx18.png",
    banner: darkBannerImage,
    bio: "AI & Infrastructure Engineer | Open Source Maintainer | Building @Caracal | Lab Leader @LFDT | GitHub Secure Fund’26 | Vercel OSS Program’26 | LFX Mentor’26, Mentee’25 | OSS Summit Speaker | Ex-DRDO",
    location: "Ahmedabad, India (UTC +05:30)",
    stats: [
