...
export default function Home() {
  return (
    <div className="min-h-screen w-full bg-white dark:bg-black relative overflow-x-hidden transition-colors duration-300">
      ...
      <div className="absolute left-0 right-0 top-[calc(var(--banner-h)+112px)] h-0 border-b border-black/30 dark:border-white/[0.15] pointer-events-none" style={{ maskImage: 'repeating-linear-gradient(to right, black 0, black 1px, transparent 1px, transparent 6px)', WebkitMaskImage: 'repeating-linear-gradient(to right, black 0, black 1px, transparent 1px, transparent 6px)' }} />

      {/* Ultra-Tiny Solid Nodes */}
      {[
        { top: 'var(--banner-h)', left: '30%' },
        { top: 'var(--banner-h)', right: '30%' },
        { top: 'calc(var(--banner-h) + 112px)', left: '30%' },
        { top: 'calc(var(--banner-h) + 112px)', right: '30%' },
      ].map((pos, i) => (
      ...
      {/* Cell 1: Banner */}
      <div className="absolute left-0 right-0 md:left-[30%] md:right-[30%] top-0 h-[var(--banner-h)] -z-0 pointer-events-auto overflow-hidden bg-[#121212] shadow-[0_4px_12px_rgba(2,6,23,0.04)] dark:shadow-[0_4px_12px_rgba(2,6,23,0.10)]">
        <Image
          src="/cover_portfolio.png"
          alt=""
          fill
          fetchPriority="high"
      ...
      <div className="absolute left-0 right-0 md:left-[30%] md:right-[30%] top-[var(--banner-h)] h-[112px] flex items-center px-4 z-50">
          ...
          <div className="flex items-center gap-4 sm:gap-5">
            <div className="relative p-[3px] rounded-[6px] sm:rounded-[8px] border-[1.5px] border-black/30 dark:border-white/[0.15] shrink-0">
              ...
              <div className="relative w-16 h-16 sm:w-20 sm:h-20 rounded-[3px] sm:rounded-[5px] overflow-hidden bg-zinc-100 dark:bg-zinc-900">
                <Image
                  src="https://github.com/RAWx18.png"
                  alt="Profile"
                  width={240}
                  height={240}
                  quality={90}
                  ...
                  className="h-full w-full origin-center translate-y-4 scale-[1.48] object-cover"
                />
              </div>
            </div>
            ...
            <div className="flex flex-col justify-center pt-8">
              ...
              <p className="text-[13px] sm:text-[14px] text-zinc-500 dark:text-zinc-400">RAWx18</p>
            </div>
          </div>
      ...
      <div className="ml-0 mr-0 md:ml-[30%] md:mr-[30%] pt-[calc(var(--banner-h)+112px)] pb-0 px-4 flex flex-col z-10 relative min-h-screen">
        <p className="text-[14px] sm:text-[15px] text-zinc-600 dark:text-zinc-300 leading-relaxed mt-4">
          Building AI infrastructure and Security systems that developers can trust.
        </p>

        <ul className="text-[14px] sm:text-[15px] text-zinc-600 dark:text-zinc-300 leading-relaxed mt-4 pl-4">
          <li className="flex gap-1.5"><span>•</span><span>Love building products, open source, startups, and collaborating with great people.</span></li>
          <li className="flex gap-1.5"><span>•</span><span>Speaker at global Open Source Summits. Invited to GitHub Maintainer Summit & Open Source Friday.</span></li>
          <li className="flex gap-1.5"><span>•</span><span>Youngest-ever Linux Foundation Lab Leader. Backed by <span className="font-semibold text-zinc-900 dark:text-white">GitHub, Microsoft, Vercel & Founders, Inc.</span></span></li>
        </ul>

        {/* Buttons */}
        <div className="flex flex-wrap items-center gap-2 mt-4">
          <Link href="https://calendly.com/ryanmadhuwala/30min" target="_blank" rel="noopener noreferrer">
            <SoftPillButton
              as="span"
              variant="primary"
          ...
          <Link href="https://mail.google.com/mail/?view=cm&fs=1&to=rawx18.dev@gmail.com" target="_blank" rel="noopener noreferrer">
            <SoftPillButton
              as="span"
              variant="secondary"
              className="px-3 py-1.5 !text-[12px]"
        ...
        <div id="contact" className="mt-6 scroll-mt-24">
          ...
          <div className="flex flex-wrap gap-1.5">
            {[
              { name: 'GitHub', href: 'https://github.com/RAWx18', icon: <path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22" stroke="currentColor" strokeWidth="2" fill="none"></path> },
              { name: 'Twitter', href: 'https://x.com/RAWx18_dev', icon: <path d="M4 4l11.733 16h4.267l-11.733 -16zM4 20l6.768 -6.768M20 4l-6.768 6.768" stroke="currentColor" strokeWidth="2" fill="none" /> },
              { name: 'LinkedIn', href: 'https://www.linkedin.com/in/ryanmadhuwala', icon: <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6zM2 9h4v12H2zM4 2a2 2 0 1 1-2 2 2 2 0 0 1 2-2z" stroke="currentColor" strokeWidth="2" fill="none"></path> },
            ].map((social, i) => (
          ...
          <div className="relative pt-6 pb-2">
            <div className="flex flex-wrap gap-2 w-full">
              {skills.map((skill, index) => {
                ...
                const isLocal = skill.icon?.startsWith('/');
                  ...
                  <div key={index} className="grow flex items-center justify-center gap-2 px-3 py-1.5 bg-zinc-50 hover:bg-zinc-100 dark:bg-[#0a0a0a] dark:hover:bg-[#121214] border border-black/30 dark:border-white/[0.15] rounded-[6px] transition-colors duration-200 cursor-default">
                    {iconSrc && (
                      <img
                        ...
                        loading="lazy"
                        decoding="async"
                        className={`h-3.5 w-3.5 opacity-80 ${isLocal ? 'grayscale dark:invert' : isUrl ? 'rounded-sm grayscale' : ''}`}
                      />
                    )}
        ...
        <div id="education" className="mt-6 flex flex-col relative z-10 scroll-mt-24">
          ...
          <div className="py-2 relative mt-1">
            ...
            {/* Horizontal line below Education heading */}
            <div className="absolute bottom-0 left-[-100vw] right-[-100vw] h-0 border-b border-black/30 dark:border-white/[0.15] pointer-events-none" style={{ maskImage: 'repeating-linear-gradient(to right, black 0, black 1px, transparent 1px, transparent 6px)', WebkitMaskImage: 'repeating-linear-gradient(to right, black 0, black 1px, transparent 1px, transparent 6px)' }} />
            {/* Intersections */}
            <div className="absolute bottom-0 -left-4 w-[2px] h-[2px] bg-black/50 dark:bg-white/[0.25] -translate-x-1/2 translate-y-1/2 pointer-events-none z-20" />
            <div className="absolute bottom-0 -right-4 w-[2px] h-[2px] bg-black/50 dark:bg-white/[0.25] translate-x-1/2 translate-y-1/2 pointer-events-none z-20" />
          ...
          <div className="pt-6 pb-2">
            <div className="flex items-start justify-between gap-3">
              <div className="flex flex-col">
                <h3 className="text-[15px] sm:text-[16px] font-bold text-zinc-900 dark:text-zinc-100 leading-snug">Indian Institute of Information Technology, Gwalior</h3>
                <p className="text-[13px] sm:text-[14px] text-zinc-600 dark:text-zinc-300 mt-0.5">BTech (Dropout), Computer Science</p>
              </div>
              <span className="shrink-0 whitespace-nowrap text-[12px] font-medium text-zinc-500 dark:text-zinc-400">2023 – 2025</span>
            </div>

            <div className="mt-3 flex flex-wrap gap-2">
              <span className="rounded-[4px] border border-zinc-300/50 bg-zinc-200/50 px-1.5 py-[1px] text-[11px] font-medium text-zinc-600 dark:border-zinc-700/50 dark:bg-zinc-800/50 dark:text-zinc-400">CGPA 7.8</span>
              <span className="rounded-[4px] border border-zinc-300/50 bg-zinc-200/50 px-1.5 py-[1px] text-[11px] font-medium text-zinc-600 dark:border-zinc-700/50 dark:bg-zinc-800/50 dark:text-zinc-400">JEE 99.1 %ile</span>
            </div>

            <p className="mt-3 text-[12.5px] leading-relaxed text-zinc-500 dark:text-zinc-400">
        ...
        {/* Other Activities */}
        <div id="activities" className="mt-6 flex flex-col relative z-10 scroll-mt-24">
          {/* Top full-width line */}
          ...
          <div className="py-2 relative mt-1">
            <h2 className="text-[18px] font-bold text-zinc-900 dark:text-zinc-100 tracking-tight">Other Activities</h2>
